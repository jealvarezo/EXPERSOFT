...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/AreasAdminCSS.css" />
			...
			<div id="fdw" >
				<nav>
					<ul>
						...
						<li class="current"><a href="AreasAdmin.html">Areas<span class="arrow"></span></a>
							<ul style="display: none;" class="sub_menu">
								<li class="arrow_top"></li>
						...
						<li><a href="UsuariosAdmin.html">Usuarios<span class="arrow"></span></a>
							<ul style="display: none;" class="sub_menu">
								<li class="arrow_top"></li>
